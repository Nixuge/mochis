...
export class NetuE extends VideoExtractor {
  ...
  override extract = async (): Promise<ISource> => {
    ...
    const body = {
      'sh':"762384534ad2168058529199987f15351806dc76", // HARDCODED FOR NOW. NEED TO EVAL THE HUGE CHINESE TEXT THEN RETURN "shh"
      'ver':'4',
      'secure':"0",
      'adb': adb,
    ...
    const headers = {
      "content-type": "application/json",
      "cookie": "EU_COOKIE_LAW_CONSENT=true; uid=9SxCjxsrmotiLvDk*MFi6E9p8xMcRasF",
